var productList = [
  ...
  const clothingHeading= document.createElement('h1')
  clothingHeading.append("clothing")
  const AccessoryHeading= document.createElement('h1')
  AccessoryHeading.append("Accessory")

 body.append(clothingHeading)
 ...
 productList.map((product)=>{
    ...
    if(product.isAccessory == false){// its a clothing item
        const newCard= document.createElement("div")
        //class 
        const clothImg= document.createElement("img")
        clothImg.src= product.preview 
